## 🛡️ GovLLM-Sentinel Security Badge — Llama 3.1 8B

**Score: 59/100 · Grade: F · 17/29 vectors resisted**

---

### Proposal

I'd like to propose adding a GovLLM-Sentinel security badge to this repository's README. Llama 3.1 8B scored **59/100** (Grade F) in an automated security evaluation covering 29 attack vectors across 5 languages.
