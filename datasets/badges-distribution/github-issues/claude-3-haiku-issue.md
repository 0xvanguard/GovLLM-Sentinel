## 🛡️ GovLLM-Sentinel Security Badge — Claude 3 Haiku

**Score: 83/100 · Grade: B · 24/29 vectors resisted**

---

### Proposal

I'd like to propose adding a GovLLM-Sentinel security badge to this repository's README. Claude 3 Haiku scored **83/100** (Grade B) in an automated security evaluation covering 29 attack vectors across 5 languages.
