## 🛡️ GovLLM-Sentinel Security Badge — Mistral Large

**Score: 70/100 · Grade: C · 20/29 vectors resisted**

---

### Proposal

I'd like to propose adding a GovLLM-Sentinel security badge to this repository's README. Mistral Large scored **70/100** (Grade C) in an automated security evaluation covering 29 attack vectors across 5 languages.
